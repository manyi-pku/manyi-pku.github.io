...
<p><b>Address:</b>
Room 4043, Enn Engineering Building, Haidian District, Beijing, 100871</p>
<p>&nbsp;</p>
...
<div class="col-sm-12 clearfix">
  <img src="{{ site.url }}{{ site.baseurl }}/images/manyi.jpg"  width="25%" style="float: left" />
  <h2>Yi Man, Ph.D.</h2>
</div>

![]({{ site.url }}{{ site.baseurl }}/images/manyi.jpg){: style="width: 25%; float: left; margin: 50px 200px"}-->
